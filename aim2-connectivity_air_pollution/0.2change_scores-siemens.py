...
df = pd.read_pickle(join(PROJ_DIR, DATA_DIR, "data_qcd_delta-siemens.pkl"))
...
rci.to_pickle(join(PROJ_DIR, DATA_DIR, 'delta_rsFC-rci-siemens.pkl'))
rci_abs.to_pickle(join(PROJ_DIR, DATA_DIR, 'delta_rsFC-rci_abs-siemens.pkl'))

rci.to_csv(join(PROJ_DIR, DATA_DIR, 'delta_rsFC-rci-siemens.csv'))
rci_abs.to_csv(join(PROJ_DIR, DATA_DIR, 'delta_rsFC-rci_abs-siemens.csv'))